...
export function getEnvironmentVariables(): EnvironmentVariables {
    let {PROJECT_ID, BUCKET_NAME, BLAISE_API_URL, SERVER_PARK, BIMS_API_URL, BIMS_CLIENT_ID} = process.env;
    ...
    return {BLAISE_API_URL, PROJECT_ID, BUCKET_NAME, SERVER_PARK, BIMS_API_URL, BIMS_CLIENT_ID};
}
