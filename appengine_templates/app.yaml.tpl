...
env_variables:
  ...
  GET_USERS_BY_ROLE_CLOUD_FUNCTION_URL: _GET_USERS_BY_ROLE_CLOUD_FUNCTION_URL
  DQS_API_RATE_LIMIT: _DQS_API_RATE_LIMIT
  DQS_PAGE_RATE_LIMIT: _DQS_PAGE_RATE_LIMIT
