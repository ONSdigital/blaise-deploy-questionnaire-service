...
describe("Field period to text test", () => {
  ...
  it("should return 'August 2020' for field period 2012", () => {
    expect(fieldPeriodToText("DST2008A")).toBe("August 2020");
  });

  it("should return 'August 2020' for field period 2012", () => {
    expect(fieldPeriodToText("BAS2008")).toBe("August 2020");
  });

  it("should return 'February 2020' for field period 2012", () => {
    expect(fieldPeriodToText("LMS2102_CC1")).toBe("February 2021");
  });
