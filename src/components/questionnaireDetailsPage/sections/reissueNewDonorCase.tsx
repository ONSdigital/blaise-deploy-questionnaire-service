...
function ReissueNewDonorCase({ questionnaire }: Props): ReactElement {
  ...
  function reissueNewDonorCaseButtonClicked() {
    ...
    if (trimmedUser === "") {
      ...
      setError(false);
      setErrorMessage("");
      navigate("/reissueNewDonorCaseConfirmation", {
        state: { section: "reissueNewDonorCase", questionnaire: questionnaire, user: trimmedUser },
      });
    }
  }
    ...
    <>
      <div className="ons-summary ons-u-mb-m">
        <div className="ons-summary__group">
          <Panel>
            To assign a new donor case to an interviewer who already has one, select their username
            and click <b>Reissue Donor Case</b>.
          </Panel>
