        ...
        <div className="ons-summary__group">
          ...
          <table className="ons-summary__items">
            ...
            <tbody className="ons-summary__item">
              <tr className="ons-summary__row ons-summary__row--has-values">
                <td className="ons-summary__item-title">
                  <div className="ons-summary__item--text">Questionnaire status</div>
                </td>
                <td
            ...
            <tbody className="ons-summary__item">
              <tr className="ons-summary__row ons-summary__row--has-values">
                <td className="ons-summary__item-title">
                  <div className="ons-summary__item--text">Modes</div>
                </td>
                <td
                  className="ons-summary__values"
                  colSpan={2}
            ...
            <tbody className="ons-summary__item">
              <tr className="ons-summary__row ons-summary__row--has-values">
                <td className="ons-summary__item-title">
                  <div className="ons-summary__item--text">Number of cases</div>
                </td>
                <td
                  className="ons-summary__values"
                  colSpan={2}
            ...
            <tbody className="ons-summary__item">
              <tr className="ons-summary__row ons-summary__row--has-values">
                <td className="ons-summary__item-title">
                  <div className="ons-summary__item--text">Install date</div>
                </td>
                <td
                  className="ons-summary__values"
                  colSpan={2}
            ...
            <tbody className="ons-summary__item">
              <tr className="ons-summary__row ons-summary__row--has-values">
                <td className="ons-summary__item-title">
                  <div className="ons-summary__item--text">Blaise version</div>
                </td>
                <td
                  className="ons-summary__values"
                  colSpan={2}
