Feature: DQS - Provide a warning and option to override OR de-activate the questionnaire when settings are not as expected
  ...
  Scenario: Display warning when settings are incorrect
    ...
    And I have selected the questionnaire package for 'OPN2301A' to deploy
    And 'OPN2301A' installs successfully
    And 'OPN2301A' has the modes 'CATI,CAWI'
    And 'OPN2301A' has the settings:
    ...
    Then the questionnaire package 'OPN2301A' is deactivated
  ...
  Scenario: Choose to continue with incorrect settings
    Given no questionnaires are installed
    And I have selected the questionnaire package for 'OPN2301B' to deploy
    And 'OPN2301B' installs successfully
    And 'OPN2301B' has the modes 'CATI,CAWI'
    And 'OPN2301B' has the settings:
      | type               | saveSessionOnTimeout | saveSessionOnQuit | deleteSessionOnTimeout | deleteSessionOnQuit | sessionTimeout | applyRecordLocking |
      | StrictInterviewing | true                 | false             | false                  | false               | 15             | false              |
    When I confirm my selection
    And I select to not provide a TO Start Date
    ...
    Then the questionnaire package 'OPN2301B' is deployed
    And the questionnaire package 'OPN2301B' is activated
  ...
  Scenario: Choose cancel and rectify settings issue
    Given no questionnaires are installed
    And I have selected the questionnaire package for 'OPN2301C' to deploy
    And 'OPN2301C' installs successfully
    And 'OPN2301C' has the modes 'CATI,CAWI'
    And 'OPN2301C' has the settings:
      | type               | saveSessionOnTimeout | saveSessionOnQuit | deleteSessionOnTimeout | deleteSessionOnQuit | sessionTimeout | applyRecordLocking |
      | StrictInterviewing | true                 | false             | false                  | false               | 15             | false              |
    When I confirm my selection
    And I select to not provide a TO Start Date
    ...
    Then the questionnaire and data is deleted from Blaise for 'OPN2301C'
    And I am returned to the landing page

  # Scenario 4
  Scenario: Install with correct settings
    Given no questionnaires are installed
    And I have selected the questionnaire package for 'OPN2301D' to deploy
    And 'OPN2301D' installs successfully
    And 'OPN2301D' has the modes 'CATI,CAWI'
    And 'OPN2301D' has the settings:
      | type               | saveSessionOnTimeout | saveSessionOnQuit | deleteSessionOnTimeout | deleteSessionOnQuit | sessionTimeout | applyRecordLocking |
      | StrictInterviewing | true                 | true              | true                   | true                | 15             | true               |
    When I confirm my selection
    And I select to not provide a TO Start Date
    And I deploy the questionnaire
    Then the questionnaire package 'OPN2301D' is deployed
    And I am presented with a successful deployment banner on the landing page
