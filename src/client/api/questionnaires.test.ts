...
import { opnQuestionnaire, questionnaireList } from "../features/step_definitions/helpers/api.mock";
...
describe("Function getSurveyDays(questionnaireName: string)", () => {
  ...
  it("should return true if created 200 response is returned", async () => {
    mock
      .onGet("/api/questionnaires/OPN2004A/surveydays")
      .reply(200, ["2021-10-05T00:00:00", "2021-10-06T00:00:00"]);
